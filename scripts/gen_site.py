...
<main class="wrap">
  ...
  <section class="install" id="install">
    ...
    <div class="install__cols">
      <div class="icard">
        <h3>Claude Code</h3>
        <p class="sub">Klon repoet og kopiér de afdelinger, du vil bruge, ind i din skills-mappe.</p>
        <div class="step"><b>1</b><div>Klon repoet<pre class="cmd">git clone {REPO}.git</pre></div></div>
        <div class="step"><b>2</b><div>Kopiér kernen (Viden &amp; Data + Direktionen) ind i <span class="inline">~/.claude/skills/</span><pre class="cmd">mkdir -p ~/.claude/skills
cp -r din-ai-organisation/03-viden-og-data/*  ~/.claude/skills/
cp -r din-ai-organisation/01-direktionen/*    ~/.claude/skills/
<span class="c"># gentag med de afdelinger du vil bruge, fx:</span>
cp -r din-ai-organisation/07-marketing/*      ~/.claude/skills/</pre></div></div>
        <div class="step"><b>3</b><div>Start Claude Code i dit projekt — skillsene trigger automatisk på danske og engelske sætninger. Eller læg dem i projektets egen <span class="inline">.claude/skills/</span>.</div></div>
      </div>
      <div class="icard">
