...
<main class="wrap">
  <section class="prose" id="intro">
    ...
    <p>Og viden samles op i stedet for at fordampe: alt nyt lander som daterede log-linjer med kildeangivelse, det faste Status-afsnit opdateres kun ved sikker viden, og varige beslutninger føres i <code>beslutninger.md</code> med begrundelse - afgjort, indtil de udtrykkeligt omgøres. Ved hver ny samtale indlæses hjernens indeks, før der svares (i Claude Code automatisk via en indbygget hook), og luk-ritualet skriver dagens læring tilbage. Organisationen bliver klogere for hver samtale.</p>
