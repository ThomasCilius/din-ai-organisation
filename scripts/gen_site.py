  ...
  <section class="install" id="installer">
    ...
    <div class="install__cols" style="grid-template-columns:1.05fr 1fr">
      <div class="icard">
        ...
        <div class="step"><b>6</b><div><b>Hooks-lag (levende hjerne).</b> Installeren wirer tre hooks merge-sikkert ind i <span class="inline">settings.json</span>: brain-inject (ambient genkaldelse), kontinuitet (hvor vi slap pr. mappe) og notify. Kræver Node.</div></div>
      </div>
      <div class="icard">
