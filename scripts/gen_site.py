...
<main class="wrap">
  <section class="prose" id="intro">
    ...
    <p>Og viden samles op i stedet for at fordampe. Undervejs i arbejdet skriver Claude selv nyt ind i hjernen som daterede noter med kilde, og varige beslutninger gemmes i <code>beslutninger.md</code> MED begrundelsen - de står ved magt, til du udtrykkeligt ændrer dem, så intet diskuteres forfra. Når du starter en ny samtale, læser Claude hjernens indeks, FØR den svarer: i Claude Desktop/Cowork via en fast åbningsregel, prompten har skrevet ind (virker, så snart du arbejder i hjernemappen), og i Claude Code automatisk i alle sessioner via en indbygget hook. Når du er færdig, skriver du bare <em>"luk sessionen"</em> - så gennemgår Claude samtalen, gemmer dagens læring de rigtige steder og kvitterer med, hvad hjernen har lært. Det er luk-ritualet: én sætning fra dig, resten er automatik. (Vil du helt slippe, kan hjernen også sættes op med en natlig opsamling, der hver aften lægger dagens beslutninger i hjernens indbakke.) Organisationen bliver klogere for hver samtale.</p>
