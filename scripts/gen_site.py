...
<main class="wrap">
  <section class="prose" id="intro">
    ...
    <p><strong>Næste skridt er installationen - og rækkefølgen er hele pointen:</strong> byg hjernen (Trin 1-2), installér skills (Trin 3), udfyld hub-filerne (Trin 4), og tjek det hele med ét sundhedstjek (Trin 5). Det hele står klar lige nedenfor.</p>
  </section>
