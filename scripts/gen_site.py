...
:root{{
  ...
  --line:#ced1d4; --accent:#ca8a10; --accent-soft:#f9e1c0; --accent-ink:#ae5100;
...
@media (prefers-color-scheme:dark){{
  :root{{ --bg:#0b121a; --surface:#151b21; --ink:#f7f5f1; --muted:#a0a5ab;
    --line:#36383a; --accent:#ca8a10; --accent-soft:#3a2c17; --accent-ink:#e8a93a;
    --btn-flade:#ca8a10; --btn-tekst:#13161a;
...
.stbtns{{display:flex;gap:10px;flex-wrap:wrap;flex:0 1 auto;min-width:0}}
@media (max-width:760px){{
  .stcard{{flex-direction:column;align-items:flex-start;gap:20px}}
  .stbtns{{width:100%}}
  .stbtns .btn{{flex:1 1 auto;justify-content:center}}
}}
