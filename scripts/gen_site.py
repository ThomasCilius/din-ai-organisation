...
<main class="wrap">
  <section class="prose" id="intro">
    ...
    <p>Under skillsene ligger hukommelsen: <strong>company brain'en</strong> - en helt almindelig mappe med markdown-filer på din egen maskine. Ingen database, ingen leverandør-silo; bare filer du kan åbne, flytte og tage backup af. Samarbejdet mellem skills og hjerne går gennem tre hub-filer i hjernens identity/-mappe: <code>virksomhedsprofil.md</code> (hvad I sælger, jeres priser, hvem I siger nej til), <code>voice-profil.md</code> (hvordan I lyder, dokumenteret med citater fra jeres egne tekster) og <code>designprofil.md</code> (hvordan I ser ud). Alle {total} skills læser dem, før de arbejder - derfor rammer tilbuddet jeres prisliste og opslaget jeres tone, uden at du forklarer det forfra.</p>
    <p>Og viden samles op i stedet for at fordampe: alt nyt lander som daterede log-linjer med kildeangivelse, det faste Status-afsnit opdateres kun ved sikker viden, og varige beslutninger føres i <code>beslutninger.md</code> med begrundelse - afgjort, indtil de udtrykkeligt omgøres. Ved hver ny samtale indlæses hjernens indeks, før der svares - på begge flader: i Claude Desktop/Cowork sørger hjernens egen CLAUDE.md-regel for det, så snart du arbejder i hjernemappen (prompten skriver reglen ind som fast åbningsritual), og i Claude Code sker det automatisk i ALLE sessioner via en indbygget hook, uanset hvilken mappe du står i. Luk-ritualet skriver dagens læring tilbage, før du går. Organisationen bliver klogere for hver samtale.</p>
